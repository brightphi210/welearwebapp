...
import useInstructorPasswordUpdate from '@/hooks/mutations/useInstructorPasswordUpdate'
import { InstructorPasswordUpdateProps } from '@/APIs/api/instructorPasswordUpdate'
...
const InstructorPasswordUpdate = () => {
      ...
      const {mutate, isPending} = useInstructorPasswordUpdate()

      const {
        handleSubmit,
        register,
        formState: { errors }
      } = useForm<InstructorPasswordUpdateProps>()

      const onSubmit = (formData: InstructorPasswordUpdateProps) => {
        mutate(formData, {
          onSuccess: () => {
